<?php
// Load application
require_once( ROOT.DS.'facebook.php' );
...
class fb_framework
{
	...
	function __construct() {
		...
		// Facebook API
		$appid		= 176664461199;
		$api_key	= '1930c7f7480c7a425a3e6f858c7aa6d3';
		$secret		= '4265e2c8d2824f32fa29247cee745161';
	...
	function init() {
		...
		if(IS_VIEWER)
			...
			ignore_user_abort(true); // Should be true if no development is being done
		...
		$this->parser	= new FaceBookClass( $this->username, $this->password );
