	...
	<script type="text/javascript">
		jQuery(document).ready(function(){
			...
			jQuery('#sm_form').submit(function(){
				...
				if(!jQuery("input[name='is_fan_page']:checked").val()){
					alert('Please select if the user is a fan page or not.');
					return false;
				}
...
<form action="" method="get" id="sm_form">
	...
	<p id="p_is_fan_page">
		Is fan page:
			<input type="radio" name="is_fan_page" value="1" id="yes_is_fan_page" />
				<label for="yes_is_fan_page">Yes</label>
			<input type="radio" name="is_fan_page" value="0" id="no_is_fan_page" />
				<label for="no_is_fan_page">No</label>
	</p>
